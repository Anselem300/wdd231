...
function displayCourses(filterSubject = null) {
    const container = document.getElementById("course-container");
    container.textContent = "";

    const filteredCourses = filterSubject ? courses.filter(course => course.subject === filterSubject) : courses;
    ...
    document.getElementById('course-count').textContent = `Total Courses: ${filteredCourses.length}`;
